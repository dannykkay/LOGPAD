 ...
 *   post:
 *     summary: Verify email with code sent after registration
 *     tags: [Auth]
 *     security: []
 *     requestBody:
 *       required: true
 ...
 * /api/v1/auth/login:
 *   post:
 *     summary: Login and receive access and refresh tokens as cookies
 *     tags: [Auth]
 *     security: []
 *     requestBody:
 *       required: true
 ...
 *     responses:
 *       200:
 *         description: Reset link sent if account exists (always returns 200 to avoid user enumeration)
 *         content:
 *           application/json:
 *             schema:
 *               type: object
